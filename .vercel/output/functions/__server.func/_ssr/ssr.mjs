...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BQz0Y190.mjs");
...
var manifest = {
	"04514e1a7d0d25c41838ab683aa7a11c57a9f6f461d6ec7973cb02b2621a4b58": {
		functionName: "saveSettingsFn_createServerFn_handler",
		importer: () => import("./log-api-DoK53v_e.mjs")
	},
	"0d502325c3bec84bc846a02aafe77d56bb15ab6770748840200bdca69a2da05f": {
		functionName: "deleteJournalFn_createServerFn_handler",
		importer: () => import("./log-api-DoK53v_e.mjs")
	},
	"4771bf0cb50e6cc7ff894d46b3f7f8945ca676eb728464a377b5ba40e58dcaf4": {
		functionName: "fetchLogState_createServerFn_handler",
		importer: () => import("./log-api-DoK53v_e.mjs")
	},
	"697dc241999c23faf5b89b55d3c6fbc7da994e265148570c88fb5fc125855b18": {
		functionName: "saveEntryFn_createServerFn_handler",
		importer: () => import("./log-api-DoK53v_e.mjs")
	},
	"6bba668daf5ca28c294757ec0c4cf209fc21bee8c4b0435a250cf700ba3b5f59": {
		functionName: "deleteEntryFn_createServerFn_handler",
		importer: () => import("./log-api-DoK53v_e.mjs")
	},
	"6d8fa0e80c55360f7558906bbb536877aab17c854a5a3f85d6f2da51c7a22584": {
		functionName: "loadAudioFn_createServerFn_handler",
		importer: () => import("./log-api-DoK53v_e.mjs")
	},
	"7190b96abcfbc71b6c0170ca5aa2a16073471f6216490f00dbf88d3527c5c04a": {
		functionName: "saveJournalFn_createServerFn_handler",
		importer: () => import("./log-api-DoK53v_e.mjs")
	},
	"fb0f6083a9842aa002caf6a9326421d4e89e42c8a04c9e0c36818b4ee945f3f9": {
		functionName: "saveAudioFn_createServerFn_handler",
		importer: () => import("./log-api-DoK53v_e.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-E3hpdVh5.mjs").then((n) => n.t),
